...
public abstract class Hilt_SurahListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SurahListFragment() {
    super();
  }

  Hilt_SurahListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SurahListFragment_GeneratedInjector) this.generatedComponent()).injectSurahListFragment(UnsafeCasts.<SurahListFragment>unsafeCast(this));
    }
  }

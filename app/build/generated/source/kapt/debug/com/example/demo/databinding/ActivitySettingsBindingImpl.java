...
public class ActivitySettingsBindingImpl extends ActivitySettingsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btn_arabic_qari, 1);
        sViewsWithIds.put(R.id.btn_translated_qari, 2);
        sViewsWithIds.put(R.id.btn_tafseer_qari, 3);
        sViewsWithIds.put(R.id.btn_transliteration_qari, 4);
    }
    // views
    @NonNull

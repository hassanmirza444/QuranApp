...
public abstract class Hilt_ParaListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ParaListFragment() {
    super();
  }

  Hilt_ParaListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ParaListFragment_GeneratedInjector) this.generatedComponent()).injectParaListFragment(UnsafeCasts.<ParaListFragment>unsafeCast(this));
    }
  }
